// список об'єктів вправ на favorites
import { firstLetterToUpper } from './utils';

// визначення функції renderFavoriteCards та перевірка наявності arrayCards
// використання Array.reduce для генерації HTML-розмітки
export function renderFavoriteCards(arrayCards) {
  if (arrayCards) {
    ...
    // відображення повідомлення, коли карток немає:
    return `
